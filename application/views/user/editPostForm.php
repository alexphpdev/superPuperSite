    ...
    <form id="formNewPost" class='col-md-8' method="POST" action="">
        ...
        <?php if ($a->status != 1): // не опубликован?>
            ...
            <? if(isset($_SESSION['admin']) && $_SESSION['admin']): ?>
                <a class="submit btn btn-default btn-lg" href="/user/publishPost/<?php echo $a->id; ?>">Опубликовать</a>&nbsp;
            <? else: ?>
                <a class="submit btn btn-default btn-lg" href="/user/sendToReconciliation/<?php echo $a->id; ?>">Опубликовать</a>&nbsp;
            <? endif; ?>
            <a class="submit btn btn-default btn-lg" href="/user/savePost/<?php echo $a->id; ?>">Сохранить</a>  
        <?php else:?>
            <a class="submit btn btn-default btn-lg" href="/user/updatePost/<?php echo $a->id; ?>">Обновить пост</a>
        <?php endif; ?>
